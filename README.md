...
# 📖 [Shahid-Notes] <a name="about-project"></a>
...
```sh
  cd my-folder
  git https://github.com/Shahid-Bagwan/Shahid-Notes
```
...
Feel free to check the [issues page](https://github.com/Shahid-Bagwan/Shahid-Notes/issues).
